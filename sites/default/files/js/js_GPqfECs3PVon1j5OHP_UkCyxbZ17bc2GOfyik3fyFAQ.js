...
(function($, Drupal){
  ...
  // var video_block = "<div id=\"123\"><script>" + iframe + "</script></div>";
  $(".video-item:nth-child(2)").after(iframe);
  // iframe.before("<div>pre-pre-content</div><div>pre-content ");
  $('#youtubelist-frame').wrap( "<div><div>SCATTERBRAINED</div><p>Everything You Need to Know about the Holidays</p></div><p>MORE SCATTERBRAINED VIDEOS</p>" );
  console.log(iframe);
  // }
  // }
})(jQuery, Drupal);;
