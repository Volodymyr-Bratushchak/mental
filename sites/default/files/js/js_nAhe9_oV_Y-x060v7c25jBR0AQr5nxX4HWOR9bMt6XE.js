 ...
 */
(function ($) {
  // function youtubelist_setvideo(href) {
  //   youtubeid = href.replace("#","");
  //   jQuery('#youtubelist-frame').attr('src','http://www.youtube.com/embed/' + youtubeid);
  // }

  // Drupal.behaviors.youtubelist = {
  //   attach: function (context, settings) {
  //     if (jQuery('#youtubelist-list a:first').length) {
  //       youtubelist_setvideo(jQuery('#youtubelist-list a:first').attr('href'));
  //       // jQuery('#youtubelist-list a').click(function(e) {
  //       //   youtubelist_setvideo(jQuery(this).attr('href'));
  //       //   return false;
  //       // });
  //     }
  //   }
  ...
  iframe.width = "100%";
  iframe.height = "http://www.youtube.com/embed/Ugcc_1hPvsk";
  iframe.frameborder = "0";

  // document.body.appendChild(iframe);
  // $( ".video-item:first" ).append(iframe);
  // jQuery( ".video-item" )[1].after(iframe);
  console.log(( ".video-item" )[1]);
